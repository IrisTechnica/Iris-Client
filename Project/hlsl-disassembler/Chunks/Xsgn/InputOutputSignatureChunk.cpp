...
ostream& HLSLDisassembler::operator<<(ostream& out, const InputOutputSignatureChunk& value)
{
	out << "// " << value.GetOutputDescription() << " signature:" << endl;
	out << "//" << endl;
