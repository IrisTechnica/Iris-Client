...
string HLSLDisassembler::ToString(OpcodeType value)
{
	switch (value)
	{
	case OpcodeType::Add :
...
NumberType HLSLDisassembler::GetNumberType(OpcodeType value)
{
	switch (value)
	{
	case OpcodeType::Add :
...
bool HLSLDisassembler::IsConditionalInstruction(OpcodeType type)
{
	switch (type)
	{
	case OpcodeType::BreakC :
...
bool HLSLDisassembler::IsDeclaration(OpcodeType type)
{
