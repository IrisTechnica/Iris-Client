...
string HLSLDisassembler::ToString(OperandType value)
{
	switch (value)
	{
...
bool HLSLDisassembler::RequiresRegisterNumberFor1DIndex(OperandType type)
{
	switch (type)
	{
	case OperandType::ImmediateConstantBuffer:
...
bool HLSLDisassembler::RequiresRegisterNumberFor2DIndex(OperandType type)
{
	switch (type)
	{
	case OperandType::InputControlPoint:
